...
const Dashboard = () => {
    ...
    return (
        <div>
            <Title align='left' font='outfit' title='Dashboard' subTitle='Monitoe=r your room listings, track bookings 
            and analyze revenue-all in one place. Stay update with
