    ...
    <div className='pt-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col md:flex-row md:justify-between mt-10'>
        <div className='flex flex-col'>
          <h1 className='text-3xl md:text-4xl font-playfair'>Expericence Luxury Like Never Before</h1>
      ...
      <div className='max-w-3xl border-y border-gray-300 my-5 py-10 text-gray-500'>
        <p>Guests will be allocated on the ground floor according to availability. You get a comfortable
          ...
          slot please make the number of guests to get the exact price for group. The Guests will be allocated
          group flooor according to availability. You get the comfortable two bedroom apartment that has a true city feeling.
        </p>
      </div>
      {/* Hosted by */}
...
hover:bg-primary-dull transition-all cursor-pointer'>Contect Now</button>
